...
public class OvertimeStrategy implements PayrollCalculationStrategy {
    ...
    public void calculate(PayrollCalculationContext context) {
        ...
        BigDecimal overtimeHours = context.getWorkedHours().subtract(monthlyHours).max(BigDecimal.ZERO);
        ...
        if (overtimePay.compareTo(BigDecimal.ZERO) > 0 && context.getEventsByCode().containsKey("HORA_EXTRA")) {
