package br.com.gommo.modules.jobposition.service;
...
import br.com.gommo.modules.jobposition.exception.JobPositionException;
import br.com.gommo.modules.jobposition.mapper.JobPositionMapper;
import br.com.gommo.modules.jobposition.repository.JobPositionRepository;
...
public class JobPositionService extends BaseService<JobPosition, JobPositionRequestDto, JobPositionResponseDto>
    ...
    protected JobPosition findEntity(UUID id) {
        return repository
                ...
                .orElseThrow(JobPositionException::notFound);
    }
