package br.com.gommo.modules.rh.person.performance.mapper;

import org.springframework.stereotype.Component;

import br.com.gommo.modules.rh.person.performance.dto.*;
...
public class PerformanceReviewMapper {
    public PerformanceReview toEntity(PerformanceReviewRequestDto dto) {
        return PerformanceReview.builder()
                ...
                .goalsSummary(dto.getGoalsSummary())
    ...
    public PerformanceReviewResponseDto toResponse(PerformanceReview entity) {
        return PerformanceReviewResponseDto.builder()
                ...
                .goalsSummary(entity.getGoalsSummary())
