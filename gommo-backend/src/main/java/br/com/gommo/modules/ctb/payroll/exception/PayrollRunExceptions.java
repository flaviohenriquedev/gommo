...
public final class PayrollRunExceptions {
    ...
    public static final String LOCKED_MSG =
            "Compet\u00eancia fechada ou cancelada n\u00e3o permite altera\u00e7\u00f5es";
    public static final String PROCESSING_CODE = "PAYROLL_PROCESSING";
    public static final String PROCESSING_MSG =
            "Compet\u00eancia em processamento n\u00e3o permite altera\u00e7\u00f5es";
    public static final String INVALID_TRANSITION_CODE = "PAYROLL_INVALID_TRANSITION";
    public static final String INVALID_TRANSITION_MSG =
            "Transi\u00e7\u00e3o de status da compet\u00eancia n\u00e3o permitida";
}
