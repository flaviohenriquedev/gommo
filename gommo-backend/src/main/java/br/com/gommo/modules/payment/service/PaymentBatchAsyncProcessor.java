...
import br.com.gommo.modules.payment.pdf.PaymentReceiptPdfParser.ParsedPaymentPage;
...
import br.com.gommo.modules.payment.service.PaymentNameMatcher.MatchResult;
...
public class PaymentBatchAsyncProcessor {
    ...
    public void processBatch(UUID batchId, byte[] sourceBytes, TenantContext capturedTenant) {
        ...
        try (PDDocument document = Loader.loadPDF(sourceBytes)) {
            ...
            Map<String, br.com.gommo.modules.person.collaborators.people.entity.Collaborator> nameIndex =
