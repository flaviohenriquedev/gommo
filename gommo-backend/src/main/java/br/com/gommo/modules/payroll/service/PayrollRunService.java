...
public class PayrollRunService extends BaseService<PayrollRun, PayrollRunRequestDto, PayrollRunResponseDto> implements IPayrollRunService {
    ...
    @Override @Transactional @PreAuthorize("hasAuthority('payroll:write')") public PayrollRunResponseDto create(PayrollRunRequestDto request) { return super.create(request); }
    @Override @Transactional @PreAuthorize("hasAuthority('payroll:write')") public PayrollRunResponseDto update(UUID id, PayrollRunRequestDto request) { return super.update(id, request); }
    @Override @Transactional @PreAuthorize("hasAuthority('payroll:delete')") public void delete(UUID id) { super.delete(id); }
    ...
    @Override protected void updateEntity(PayrollRun entity, PayrollRunRequestDto request) { mapper.updateEntity(entity, request); }
}
