...
import { TAX_CLIENT_MESSAGES } from "@/modules/tax/exceptions/tax-obligation.messages";
import type { TaxObligationCreateDto } from "@/modules/tax/dto/tax-obligation.dto";
import { emptyTaxObligationForm, taxObligationToFormDto } from "@/modules/tax/lib/tax-obligation.mapper";
import { taxObligationKeys } from "@/modules/tax/tax.query";
import { taxObligationService } from "@/modules/tax/services/tax-obligation.service";
    ...
    >
      <div className="grid gap-3 p-4 sm:grid-cols-2">
        <div className="sm:col-span-2">
          <p className="text-sm font-semibold text-base-content">{isEditing ? "Editar obrigação fiscal" : "Nova obrigação fiscal"}</p>
        </div>
        <div className="sm:col-span-2">
