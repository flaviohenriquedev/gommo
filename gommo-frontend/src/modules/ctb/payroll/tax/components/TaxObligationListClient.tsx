...
import { TAX_TABLE_COLUMNS } from "@/modules/ctb/payroll/tax/config/tax-obligation.table-columns";
import type { TaxObligation } from "@/modules/ctb/payroll/tax/dto/tax-obligation.dto";
