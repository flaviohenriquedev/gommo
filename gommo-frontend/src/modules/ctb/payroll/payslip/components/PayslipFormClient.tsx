...
import { canEditPayrollRun, isPayrollRunLocked } from "@/modules/ctb/payroll/lib/payroll-run-lifecycle";
import { payrollrunKeys } from "@/modules/ctb/payroll/payroll.query";
import type { PayslipCreateDto } from "@/modules/ctb/payroll/payslip/dto/payslip.dto";
import { PAYSLIP_CLIENT_MESSAGES } from "@/modules/ctb/payroll/payslip/exceptions/payslip.messages";
import { emptyPayslipForm, payslipToFormDto } from "@/modules/ctb/payroll/payslip/lib/payslip.mapper";
import { payslipKeys } from "@/modules/ctb/payroll/payslip/payslip.query";
import { payslipService } from "@/modules/ctb/payroll/payslip/services/payslip.service";
        ...
        return (
            <div className="p-5">
                <p className="text-sm font-medium text-error">
                    {ExceptionCapture.displayMessage(detailQuery.error, PAYSLIP_CLIENT_MESSAGES.PAYSLIP_LOAD_FAILED)}
                </p>
        ...
        >
            <FormSection id="cadastro" title="Contracheque">
                ...
                <InputCurrency
                    ...
                    onValueChange={(v) => update("grossAmount", v)}
                    emitAsDecimal
                    readOnly={readOnly}
                    wrapperClassName="sm:col-span-6"
                />
                <InputCurrency
                    ...
                    onValueChange={(v) => update("deductionsAmount", v)}
                    emitAsDecimal
                    readOnly={readOnly}
                    wrapperClassName="sm:col-span-6"
                />
                <InputCurrency
                    ...
                    onValueChange={(v) => update("netAmount", v)}
                    emitAsDecimal
                    readOnly={readOnly}
                    wrapperClassName="sm:col-span-6"
                />
