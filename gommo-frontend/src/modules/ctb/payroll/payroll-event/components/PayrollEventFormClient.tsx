...
import { BOOL_SELECT_ITEMS, PAYROLL_EVENT_TYPE_ITEMS } from "@/modules/ctb/payroll/config/payroll.constants";
...
import {
    emptyPayrollEventForm,
    payrollEventToFormDto,
} from "@/modules/ctb/payroll/payroll-event/lib/payroll-event.mapper";
    ...
    const saveMutation = useMutation({
        ...
        onError: (err: unknown) => {
            const ex = ExceptionCapture.handle(err, {
                fallbackMessage: PAYROLL_EVENT_CLIENT_MESSAGES.PAYROLL_EVENT_SAVE_FAILED,
            });
            ...
            <div className="p-5">
                <p className="text-sm font-medium text-error">
                    {ExceptionCapture.displayMessage(
                        detailQuery.error,
                        PAYROLL_EVENT_CLIENT_MESSAGES.PAYROLL_EVENT_LOAD_FAILED,
                    )}
                </p>
