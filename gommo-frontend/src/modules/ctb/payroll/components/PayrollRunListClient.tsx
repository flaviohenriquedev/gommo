...
import { PAYROLL_TABLE_COLUMNS } from "@/modules/ctb/payroll/config/payroll-run.table-columns";
import type { PayrollRun } from "@/modules/ctb/payroll/dto/payroll-run.dto";
