    ...
    return (
        <div className="flex min-h-0 flex-1 flex-col overflow-auto p-4 md:p-6">
            <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
                <div>
                    <h1 className="text-lg font-semibold tracking-tight text-base-content">Ponto</h1>
                    <p className="mt-1 text-sm text-base-content/55">
                        Configure as validações exigidas no Gommo Tick para registro de ponto.
                    </p>
                </div>
                <Card animate={false} title="Registro pelo aplicativo" subtitle="Regras aplicadas no login e antes de cada batida">
