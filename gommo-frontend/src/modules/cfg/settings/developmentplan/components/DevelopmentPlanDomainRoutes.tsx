...
import { DevelopmentPlanDomainFormClient } from "@/modules/cfg/settings/developmentplan/components/DevelopmentPlanDomainFormClient";
import { DevelopmentPlanDomainListClient } from "@/modules/cfg/settings/developmentplan/components/DevelopmentPlanDomainListClient";
import { DEVELOPMENT_PLAN_DOMAIN_CONFIGS } from "@/modules/cfg/settings/developmentplan/config/development-plan-domain.config";
