...
const statusColumn: TableColumnConfig = { id: "status", columnName: "Status", fieldValue: "status", dataType: TableDataType.BADGE };
...
export const DEVELOPMENT_PLAN_DOMAIN_CONFIGS: Record<string, DevelopmentPlanDomainConfig> = {
    ...
    actionTemplates: {
        ...
        columns: baseColumns([
            ...
            { id: "competencyName", columnName: "Competência", fieldValue: "competencyName", dataType: TableDataType.TEXT },
