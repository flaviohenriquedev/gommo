...
import { OFFBOARDING_TABLE_COLUMNS } from "@/modules/person/offboarding/config/offboarding.table-columns";
import type { Offboarding } from "@/modules/person/offboarding/dto/offboarding.dto";
