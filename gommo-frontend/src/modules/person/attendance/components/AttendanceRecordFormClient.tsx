...
} from "@/modules/person/attendance/lib/attendance-record.mapper";
import {attendancerecordKeys} from "@/modules/person/attendance/attendance.query";
    ...
    return (
        ...
        >
            <div className="grid gap-3 p-4 sm:grid-cols-2">
                ...
                <InputDate label="Data de trabalho" value={form.workDate ?? ""}
                           onValueChange={(v) => update("workDate", v)} required/>
                <InputString label="Entrada" value={form.clockIn ?? ""} onValueChange={(v) => update("clockIn", v)}
                             hint="HH:mm"/>
