...
import { ProfileDetailModal } from "@/modules/settings/appuser/components/ProfileDetailModal";
import { filterProfilesBySearch } from "@/modules/settings/appuser/lib/profile-role-filter";
...
const PROFILE_ROW_CLASS =
    "flex min-h-[2.25rem] items-center gap-2 rounded px-2 py-1.5 text-sm";
