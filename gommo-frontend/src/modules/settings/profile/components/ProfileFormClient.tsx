...
export function ProfileFormClient() {
    ...
    const navSections = useMemo(
        ...
        () => getPermissionNavSections(systemEnumFromScope(form.system)),
    ...
    const modulePermissionsQuery = useQuery({
        ...
        queryFn: () =>
            ...
            permissionCatalogService.getBySystem(form.system, selectedPermissionModule!),
        ...
        if (detailQuery.data) {
            ...
            setSelectedRoute(
                ...
                findFirstPermissionRoute(
                    ...
                    getPermissionNavSections(systemEnumFromScope(detailQuery.data.system)),
