...
import { PAYROLL_EVENT_TABLE_COLUMNS } from "@/modules/payroll/payroll-event/config/payroll-event.table-columns";
import type { PayrollEvent } from "@/modules/payroll/payroll-event/dto/payroll-event.dto";
