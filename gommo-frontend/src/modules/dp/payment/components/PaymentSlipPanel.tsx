...
import { PaymentSlipReviewDialog } from "@/modules/dp/payment/components/PaymentSlipReviewDialog";
import {
    PAYMENT_SLIP_DIVERGENT_TABLE_COLUMNS,
    PAYMENT_SLIP_NOT_FOUND_TABLE_COLUMNS,
    PAYMENT_SLIP_TABLE_COLUMNS,
} from "@/modules/dp/payment/config/payment.table-columns";
import type { PaymentSlip, PaymentSlipStatus } from "@/modules/dp/payment/dto/payment.dto";
import { PAYMENT_CLIENT_MESSAGES } from "@/modules/dp/payment/exceptions/payment.messages";
import { formatPersonName } from "@/modules/dp/payment/lib/format-person-name";
