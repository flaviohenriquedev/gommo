...
import { PaymentSlipPanel } from "@/modules/payment/components/PaymentSlipPanel";
import { PAYMENT_BATCH_TABLE_COLUMNS } from "@/modules/payment/config/payment.table-columns";
...
import { usePaymentBatchUpload } from "@/modules/payment/hooks/usePaymentBatchUpload";
...
export function PaymentBatchUploadButton({ upload }: PaymentBatchUploadButtonProps) {
    if (!upload.canWrite) {
        return null;
    }
    ...
    return (
        <>
            ...
            <Button
                ...
                loading={upload.uploadMutation.isPending}
                disabled={upload.uploadProgress !== null}
...
export function PaymentBatchPanel({
    ...
    return (
        <div className="grid w-full min-w-0 content-start gap-4">
            ...
            {showUploadButton ? <PaymentBatchUploadButton upload={upload} /> : null}
