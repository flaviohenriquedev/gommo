...
function readSettingsMode(): boolean {
    ...
    return window.localStorage.getItem(SETTINGS_MODE_STORAGE_KEY) === "1";
}
...
export function ActiveSystemProvider({ children, initialStoredSystem = null }: ActiveSystemProviderProps) {
