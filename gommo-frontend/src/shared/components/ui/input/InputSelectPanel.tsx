...
export const InputSelectPanel = forwardRef<HTMLDivElement, InputSelectPanelProps>(function InputSelectPanel(
    {
        listId,
        items,
        activeIndex,
    ...
    return (
        <div
            ref={ref}
            className={clsx("surface-popover absolute z-50 mt-1 w-full overflow-hidden", className)}
            style={style}
        >
            {items.length === 0 ? (
