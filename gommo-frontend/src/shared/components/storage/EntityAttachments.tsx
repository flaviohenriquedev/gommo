...
export function EntityAttachments({
    ...
    const startEditDocumentType = (row: AttachmentTableRow) => {
        const currentType = row.pending
            ? row.pendingItem?.documentType ?? ""
            : row.serverLink?.documentType ?? "";
        ...
        const serverRows: AttachmentTableRow[] = sortRowsByCreatedAtDesc(
            activeLinks
                ...
                .map((link) => ({
                    ...
                    sizeLabel: link.storageObject?.contentLength != null
        ...
        <div className="grid gap-3">
            ...
            {deferUpload ? (
                <p className="text-xs text-base-content/45">
                    Os arquivos serão enviados ao salvar o cadastro.
                </p>
            ) : null}
                                ...
                                <>
                                    ...
                                    <TableActionButton
                                        ...
                                        onClick={async () => {
                                            ...
                                            if (!(await SystemAlert.confirmDelete("Deseja remover este arquivo?"))) return;
