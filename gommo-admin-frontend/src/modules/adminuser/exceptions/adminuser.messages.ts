export const ADMIN_USER_CLIENT_MESSAGES = {
...
export const ADMIN_USER_MESSAGES = {
    ...
    ADMIN_USER_EMAIL_EXISTS: "Este e-mail já está cadastrado",
    ADMIN_USER_PASSWORD_REQUIRED: "Informe a senha",
    ADMIN_USER_PASSWORD_TOO_SHORT: "A senha deve ter no mínimo 8 caracteres",
} as const;
