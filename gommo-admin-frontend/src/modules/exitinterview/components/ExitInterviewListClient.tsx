...
import { EXITINTERVIEW_TABLE_COLUMNS } from "@/modules/exitinterview/config/exit-interview.table-columns";
import type { ExitInterview } from "@/modules/exitinterview/dto/exit-interview.dto";
