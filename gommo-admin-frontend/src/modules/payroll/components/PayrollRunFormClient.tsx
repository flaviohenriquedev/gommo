        ...
        return (
            <div className="gommo-crud-panel-inset">
                <p className="text-sm font-medium text-error">
                    {ExceptionCapture.displayMessage(detailQuery.error, PAYROLL_CLIENT_MESSAGES.PAYROLL_LOAD_FAILED)}
                </p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
                <div className="sm:col-span-2">
                    <p className="text-sm font-semibold text-base-content">
                        {isEditing ? "Editar folha" : "Novo(a) folha"}
                    </p>
                </div>
                ...
                <InputSelect
                    ...
                    onValueChange={(v) =>
                        update("payrollStatus", (v || undefined) as PayrollRunCreateDto["payrollStatus"])
                    }
